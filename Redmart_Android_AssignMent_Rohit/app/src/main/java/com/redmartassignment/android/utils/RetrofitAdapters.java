...
import com.redmartassignment.android.interfaces.webInterface.RetrofitWebInterface;
...
public class RetrofitAdapters {
    ...
    private static RetrofitWebInterface retrofitAdapterInterface;

    public static RetrofitWebInterface getWebServiceInterface() {
        ...
        retrofitAdapterInterface = restAdapter.create(RetrofitWebInterface.class);
        return retrofitAdapterInterface;
    }
